...
export var Input = function (props) {
    ...
    var cls = classNames('tb-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: cls, style: style },
        prepend && React.createElement("div", { className: "tb-input-group-prepend" }, prepend),
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-" + icon }))),
        React.createElement("input", __assign({ className: "tb-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "tb-input-group-append" }, append)));
};
