...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "tb-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "tb-upload-list-item", key: item.uid },
            ...
            (item.status === 'uploading' || item.status === 'ready') && (React.createElement(Progress, { percent: item.percent || 0 }))));
    })));
};
